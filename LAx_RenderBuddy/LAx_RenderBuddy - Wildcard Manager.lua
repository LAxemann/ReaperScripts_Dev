...
reaper.SetExtState("LAx_RenderBuddy", "WildcardManagerCommandID", tostring(cmdID), true)
...
----------------------------------------------------------------------------------------
-- Run target file
runFile(reaper.GetExtState("LAx_RenderBuddy", "Directory") .. DTAV .. sep .. "wildcardManager" .. sep .. "wildcardManager", true)
