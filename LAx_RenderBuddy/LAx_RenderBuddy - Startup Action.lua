...
reaper.SetExtState("LAx_RenderBuddy", "StartupActionCommandID", tostring(cmdID), true)
...
----------------------------------------------------------------------------------------
-- Run target file
runFile(reaper.GetExtState("LAx_RenderBuddy", "Directory") .. DTAV .. sep .. "startupAction", true)
